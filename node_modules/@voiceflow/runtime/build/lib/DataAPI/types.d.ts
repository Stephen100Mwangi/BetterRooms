...
export interface DataAPI<P extends Program<any, any> = Program<Node, Command>, V extends Version<any> = Version<VersionPlatformData>, PJ extends Project<any, any> = Project<BasePlatformData, BasePlatformData>> {
    init(): Promise<void>;
