...
export declare type Event<K extends EventType, TF extends TraceFrame = TraceFrame> = EventMap<TF>[K];
export declare type CallbackEvent<K extends EventType, TF extends TraceFrame = TraceFrame> = Event<K, TF> & {
    runtime: Runtime;
};
export declare type EventCallback<K extends EventType, TF extends TraceFrame = TraceFrame> = (event: CallbackEvent<K, TF>) => void | Promise<void>;
export declare type EventCallbackMap<TF extends TraceFrame = TraceFrame> = {
