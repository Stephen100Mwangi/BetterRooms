...
const About = () => {
  return (
    <div className='bg-background h-[calc(100vh-120px)] relative'>
      ...
      <div className='w-[700px] h-[250px] px-5 absolute bottom-5 border-none rounded-lg shadow-2xl right-5 flex space-x-10 overflow-x-auto scrollbar-hide'>
        <div className='h-[240px] w-[200px] min-w-[200px] shadow-inner text-black my-auto rounded-lg flex items-center text-center justify-center'>
        ...
        <div className='h-[240px] w-[200px] min-w-[200px] shadow-inner text-black my-auto rounded-lg flex items-center text-center justify-center'>
          <p>Dynamic Pricing Recommendations</p>
        </div>
        <div className='h-[240px] w-[200px] min-w-[200px] shadow-inner text-black my-auto rounded-lg flex items-center text-center justify-center'>
          <p>Host Listing Optimization</p>
        </div>
        <div className='h-[240px] w-[200px] min-w-[200px] shadow-inner text-black my-auto rounded-lg flex items-center text-center justify-center'>
          <p>Enhanced Search Experience</p>
        </div>
        <div className='h-[240px] w-[200px] min-w-[200px] shadow-inner text-black my-auto rounded-lg flex items-center text-center justify-center'>
          <p>Personalized Accommodation Recommendations</p>
        </div>
