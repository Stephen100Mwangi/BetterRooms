...
const BookText = () => {
  ...
  return (
    <div className='min-h-[calc(100vh-120px)] bg-background flex flex-col items-center space-x-2 space-y-10 rounded-lg shadow-2xl'>
        ...
        <div className='footer flex space-x-5'>
            <button onClick={()=>setPage((current) => current - 1)} disabled={page === 0} className='text-white bg-hero p-2 px-6 rounded-lg'>Previous</button>
            <button onClick={()=>setPage((current) => current + 1)} className='text-white bg-hero p-2 px-6 rounded-lg'>
