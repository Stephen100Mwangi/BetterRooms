(function (global, factory) {
	      ...
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          ...
	          case 5:
	            ...
	            _iterator7 = _createForOfIteratorHelper$1(Editor.nodes(editor, {
	              at: at,
	              reverse: reverse,
	              voids: voids
	            }));
	...
	var GeneralTransforms = {
	  ...
	  transform: function transform(editor, op) {
	    editor.children = vt(editor.children);
	    var selection = editor.selection && vt(editor.selection);

	    try {
	      selection = applyToDraft(editor, selection, op);
	    } finally {
	      editor.children = pt(editor.children);

	      if (selection) {
	        editor.selection = n(selection) ? pt(selection) : selection;
	      } else {
