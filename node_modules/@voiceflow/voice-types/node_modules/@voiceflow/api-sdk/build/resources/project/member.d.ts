...
declare class MemberResource extends BaseResource<typeof SMember['schema'], ModelIDKey, MemberResource> {
    ...
    list<P extends Partial<Member<BasePlatformData>>>(projectID: ProjectID, fields: Fields): Promise<P[]>;
    list<P extends Member<any> = Member<BasePlatformData>>(projectID: ProjectID): Promise<P[]>;
    list<P extends BasePlatformData>(projectID: ProjectID): Promise<Member<P>[]>;
    get<P extends Partial<Member<BasePlatformData>>>(projectID: ProjectID, fields: Fields): Promise<P>;
    get<P extends Member<any> = Member<BasePlatformData>>(projectID: ProjectID, fields: Fields): Promise<P>;
    ...
    create<P extends Omit<Member<any>, ModelIDKey>>(projectID: ProjectID, body: P): Promise<P & Pick<Member<any>, ModelIDKey>>;
    update<P extends BasePlatformData>(projectID: ProjectID, body: Omit<Member<P>, ModelIDKey>): Promise<Member<P>>;
    update<P extends Omit<Member<any>, ModelIDKey>>(projectID: ProjectID, body: P): Promise<P & Pick<Member<any>, ModelIDKey>>;
